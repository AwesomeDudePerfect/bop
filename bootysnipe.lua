getgenv().webhook = "https://discord.com/api/webhooks/1102031995506266162/qoP0abw3x1dRilmnwUeZyC__qJl87J2C8yxD6R_vwicx6FRfQ2Bo9ZZmWkIKaDo0vdNZ"
getgenv().place = "15502339080"
getgenv().alts = {"ShwaDev", "ShwaDevW", "ShwaDevY", "ShwaDevZ", "historianaverage", "assistancereaction"}
getgenv().buyAnything = true

if game.placeId ~= "15502339080" then
    loadstring(game:HttpGet("https://raw.githubusercontent.com/AwesomeDudePerfect/bop/main/tp-to-plaza.lua"))()
else
    loadstring(game:HttpGet("https://raw.githubusercontent.com/AwesomeDudePerfect/bop/main/snipe.lua"))()
end
    ...
    local message1 = {
        ...
        ['embeds'] = {{
            ...
            ['fields'] = {{
                ...
                ['name'] = "*SNIPER INFO* :",
                ['value'] = string.format("**Price: ** %s\n**Ping: ** %s ms\n**Status: **", tostring(gems), tostring(ping), failMessage)
            }},
        }},
    }
